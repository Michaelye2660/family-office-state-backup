...
echo "| **B5 知识库摘录边界**〔🔴 **GM 逾期项**·ADJ-0731-61⑥ 自认〕 | 2026-07-31（ADJ-0731-54⑤ 步2 之自立时限「其后第一个 GM 会话内裁毕·不得跨轮」） | ${AGE_0731} 日 | GM | 分节表 \`docs/section-size-adjudicator-knowledge.md\` 已备（14 节·对平 0 B）·**可径裁不须重跑**；**龄不得因换代而重置**（-51②）·GM-10 自陈「**不援余额不足为正当理由——那是原因，不是理由**」 |"
echo "| **B1 宪法迁移边界**／**B6 台账上限数与归档批次** | 2026-07-31 | ${AGE_0731} 日 | GM | 两表皆已对平 0 B（\`section-size-constitution.md\` 11 节 22 条标记／\`section-size-portfolio-state.md\`）·**下任可径裁不须重跑**（-61⑦） |"
...
echo
echo "**🔴 治理时钟＝SGT（ADJ-0801-01① 裁）·本包生成日 ${GENDATE} 系 SGT 日**。"
echo "**🔴 龄之回补申报（ADJ-0801-01③b）**：本包此前之龄系按容器 UTC 日计，**较 SGT 少一日**；改用 SGT 后**一切龄自动 +1 日**。"
echo "**该 +1 系口径回补，非重新起算** —— 照 \`-51②\`「**龄不得因换代而重置**」并核：**回补是向上加，不得成为归零之机会**。"
echo
