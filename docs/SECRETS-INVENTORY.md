...
| GIT_SIGNING_KEY_B64（**暂缓·从未创建**） | CGM commit SSH签名（选项b当日暂缓,〔M〕44追注二;方案封存signing-setup.md） | claude.ai/code 环境变量（base64单行） | 本地重新ssh-keygen→GitHub Signing Key替换→更新环境变量（流程见docs/signing-setup.md） |
