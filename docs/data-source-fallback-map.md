...
| 件号 | 内容 | 分类 | 状态 |
|---|---|---|---|
| `DR-20260728-01` | IWDA(ISIN IE00B4L5Y983)行业与国家权重·**须真独立源(明确避开 FMP 及其转发者)** | 乙类＋需真异源 | **已投放**·首发 relay `c0fed0df07deae8608798310a89554e51c8ff24c`·**追加(7)源之性质判定后 relay `2bff78059cadc8caa38334a075559c16174c1f46`**(投放在前、探针三立规在后·**以追加方式补入并如实标注增补时序·不作无痕修改**)·候答卷 |
