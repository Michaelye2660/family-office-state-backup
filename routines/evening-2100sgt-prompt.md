...
第0步 时间与事件定位：先确定今天真实日期（搜索必须用真实当天日期，严禁旧年份）；对照〔K〕事件日历，重大数据/财报公布前后1小时，大额单一律标注"限价单/避开公布窗口"（美国经济数据多在SGT晚间公布，晚间场尤须注意今晚有无CPI/非农/FOMC）。
...
2) 欧美盘前：美股期货与欧股盘中表现、今晚重要数据/财报时间表、关键板块（半导体/AI、医疗、能源、公用/电网、工业自动化、航空国防）；**⚠️E6第一修(2026-07-28)后:MSCI World 远期P/E百分位之「AI每周动态权益规则/五档估值定档表/趋势闸」已全部废除**——IWDA 改**固定中枢38%±3%再平衡带(机制甲)**，**估值百分位不再驱动任何权重动作**；如仍取该读数，只作市场环境背景，**不得据以提示调仓**；
3) 利率：美债2Y/10Y/30Y、Fed最新表态与降息预期变化（→新币REITs信号）；**⚠️「30年期突破5%→DTLA信号」已作废**——**DTLA 长债 2026-07-28 正式废除**(委托人「废」·5%归短债)，**30Y 读数自此不构成任何建仓信号**，只作利率环境背景；
